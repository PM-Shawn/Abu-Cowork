...
trigger: 用户要求使用 Claude API、Anthropic SDK、Agent SDK 构建应用，或代码中导入了 anthropic/@anthropic-ai/sdk/claude_agent_sdk
do-not-trigger: 用户使用其他 AI SDK（如 openai），或进行与 Claude API 无关的通用编程
---
