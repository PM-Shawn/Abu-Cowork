...
- **A new expert introduces itself in a first conversation.** Creating an expert now opens a conversation where it says what it can do and suggests how to start; that conversation stays in your list so you can come back to it. When you ask Abu to create an expert, it proposes a configuration first and asks before writing it.
