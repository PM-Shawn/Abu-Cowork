...
export const PROVIDER_GUIDES: Record<string, ProviderGuideInfo> = {
  ...
  moonshot: {
    hint: '在 Kimi 开放平台创建 API Key',
    hintEn: 'Create an API key on the Kimi open platform',
    url: 'https://platform.kimi.com',
    urlLabel: 'Kimi 开放平台',
    urlLabelEn: 'Kimi Open Platform',
  },
  zhipu: {
    hint: '在智谱GLM 开放平台创建 API Key',
    hintEn: 'Create an API key on the Zhipu GLM open platform',
    url: 'https://bigmodel.cn/glm-coding',
    urlLabel: '智谱GLM 开放平台',
    urlLabelEn: 'Zhipu GLM Open Platform',
  },
  minimax: {
  ...
  volcengine: {
    ...
    url: 'https://ai.volcengine.com/activity/agentplan',
    urlLabel: '火山引擎方舟控制台',
