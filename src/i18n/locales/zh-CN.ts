...
const zhCN: TranslationDict = {
  ...
  diagnostic: {
    ...
    exportPrivacyText: '只有你勾选的对话会被包含；API Key、密钥、未勾选的对话永远不会被包含。详细规则见包内 README.txt。',
    uploadButton: '反馈给开发者',
    ...
    conversationPickerTitle: '选择要附带的对话',
    conversationPickerSearchPlaceholder: '搜索对话标题',
    conversationPickerLoadMore: '加载更多',
    ...
    conversationPickerPrivacyHint: '所选对话的完整消息内容会随反馈提交，用于定位问题。',
