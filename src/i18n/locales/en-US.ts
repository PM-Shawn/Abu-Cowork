...
const enUS: TranslationDict = {
  ...
  diagnostic: {
    ...
    exportPrivacyText: 'Only the conversations you select are included. API keys, secrets, and unselected conversations are never included. See README.txt inside for details.',
    ...
    conversationPickerTitle: 'Attach conversations',
    conversationPickerSearchPlaceholder: 'Search by title',
    conversationPickerLoadMore: 'Load more',
    ...
    conversationPickerPrivacyHint: 'The full message content of selected conversations will be submitted with your feedback, to help us diagnose the issue.',
