...
const enUS: TranslationDict = {
  ...
  settings: {
    ...
    labsExpPluginSystemTitle: 'Plugin System',
    labsExpPluginSystemDesc: 'Switch the Toolbox to a plugin-oriented layout: Skills/Agents/MCP merge into Plugins / Skills / Connectors tabs.',
    labsExpPluginSystemWhere: 'Once on: the Toolbox tabs become "Plugins / Skills / Connectors"',
