 ...
 * and `highRiskSites.test.ts` pins this shared implementation's source.
 *
 ...
 */
const MONEY_MOVEMENT_PATH_KEYWORDS = [
  'transfer',
  'payment',
  'checkout',
  'wire',
 ...
 */
export function classifyHighRiskUrl(url) {
  if (!url) return null;
  let parsed;
  try {
    parsed = new URL(url);
...
export function isHighRiskUrl(url) {
