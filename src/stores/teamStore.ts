...
/** Read-only in the UI: shipped with the app, or owned by an installed plugin. */
export function isReadOnlyTeam(team: Pick<Team, 'id'>): boolean {
  return isBuiltinTeam(team) || isPluginTeam(team);
}
