...
- **Your own expert team is renamed, not made uneditable, when a newly shipped built-in team takes its name**: v0.43 adds built-in finance-reconciliation and recruiting teams. If you had already created a team under one of those names, yours becomes “Name 2” on upgrade with everything it held intact. Left alone the two would look identical, and yours could never be saved again because every edit would trip the duplicate-name check.
